      ...
      <form onSubmit={validiateInputs}>
        ...
        <div className="mb-3" style={inputLayoutStyle}>
          <input
            ...
            className="form-control"
            name="address"
            placeholder="Address (Incl. Society Name, Flat Number)"
        ...
        <div className="mb-3" style={inputLayoutStyle}>
          <input
            ...
            className="form-control"
            name="ChairmanName"
            placeholder="Society Chairman Name"
            value={credentials.ChairmanName}
            onChange={onChange}
            style={inputStyle}
          />
        </div>
        <div className="mb-3" style={inputLayoutStyle}>
          <input
            ...
            className="form-control"
            name="Chairmanemail"
            placeholder="Society Chairman's Email Address"
            value={credentials.Chairmanemail}
            onChange={onChange}
            style={inputStyle}
          />
          <span
            ...
            >
              {mobileNumber.length === 12 ? (
                <>
                  ...
                  >
                    <path
                      d="M4.31998 9L12 1.64681L10.28 0L7.29998 2.85319L4.31998 5.70638L1.71998 3.21702L-1.98364e-05 4.86383L4.31998 9Z"
                      fill="#C47ECC"
                    />
                  </svg>
                  Verified{" "}
        ...
        >
          <span style={{ marginRight: "5px" }}>Proceed</span>{" "}
